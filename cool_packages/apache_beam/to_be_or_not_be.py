"""
    ..synopsis::
        This module contains the functions to be used in the Apache Beam pipeline.
"""
...
def run_pipeline():
    ...
    with beam.Pipeline(options=options) as p:
        (p
         ...
         | "Create words" >> beam.Create(["to be or not to be that is the question or be hungry be foolish"])
